...
.neutral-background-weak ::-moz-selection {
  background-color: var(--neutral-on-background-weak);
  color: var(--neutral-background-weak);
}

.neutral-background-medium ::-moz-selection {
  background-color: var(--neutral-on-background-weak);
  color: var(--neutral-background-weak);
}

.neutral-background-strong ::-moz-selection {
  background-color: var(--neutral-on-background-weak);
  color: var(--neutral-background-weak);
}

.neutral-background-alpha-weak ::-moz-selection {
  background-color: var(--neutral-on-background-weak);
  color: var(--neutral-background-weak);
}

.neutral-background-alpha-medium ::-moz-selection {
  background-color: var(--neutral-on-background-weak);
  color: var(--neutral-background-weak);
}

.neutral-background-alpha-strong ::-moz-selection {
  background-color: var(--neutral-on-background-weak);
  color: var(--neutral-background-weak);
}
...
.neutral-solid-weak ::-moz-selection {
  background-color: var(--neutral-background-weak);
  color: var(--neutral-on-background-medium);
}

.neutral-solid-medium ::-moz-selection {
  background-color: var(--neutral-background-weak);
  color: var(--neutral-on-background-medium);
}

.neutral-solid-strong ::-moz-selection {
  background-color: var(--neutral-background-weak);
  color: var(--neutral-on-background-medium);
}
...
.brand-background-weak ::-moz-selection {
  background-color: var(--brand-on-background-weak);
  color: var(--brand-background-weak);
}

.brand-background-medium ::-moz-selection {
  background-color: var(--brand-on-background-weak);
  color: var(--brand-background-weak);
}

.brand-background-strong ::-moz-selection {
  background-color: var(--brand-on-background-weak);
  color: var(--brand-background-weak);
}

.brand-background-alpha-weak ::-moz-selection {
  background-color: var(--brand-on-background-weak);
  color: var(--brand-background-weak);
}

.brand-background-alpha-medium ::-moz-selection {
  background-color: var(--brand-on-background-weak);
  color: var(--brand-background-weak);
}

.brand-background-alpha-strong ::-moz-selection {
  background-color: var(--brand-on-background-weak);
  color: var(--brand-background-weak);
}
...
.brand-solid-weak ::-moz-selection {
  background-color: var(--brand-background-weak);
  color: var(--brand-on-background-medium);
}

.brand-solid-medium ::-moz-selection {
  background-color: var(--brand-background-weak);
  color: var(--brand-on-background-medium);
}

.brand-solid-strong ::-moz-selection {
  background-color: var(--brand-background-weak);
  color: var(--brand-on-background-medium);
}
...
.accent-background-weak ::-moz-selection {
  background-color: var(--accent-on-background-weak);
  color: var(--accent-background-weak);
}

.accent-background-medium ::-moz-selection {
  background-color: var(--accent-on-background-weak);
  color: var(--accent-background-weak);
}

.accent-background-strong ::-moz-selection {
  background-color: var(--accent-on-background-weak);
  color: var(--accent-background-weak);
}

.accent-background-alpha-weak ::-moz-selection {
  background-color: var(--accent-on-background-weak);
  color: var(--accent-background-weak);
}

.accent-background-alpha-medium ::-moz-selection {
  background-color: var(--accent-on-background-weak);
  color: var(--accent-background-weak);
}

.accent-background-alpha-strong ::-moz-selection {
  background-color: var(--accent-on-background-weak);
  color: var(--accent-background-weak);
}
...
.accent-solid-weak ::-moz-selection {
  background-color: var(--accent-background-weak);
  color: var(--accent-on-background-medium);
}

.accent-solid-medium ::-moz-selection {
  background-color: var(--accent-background-weak);
  color: var(--accent-on-background-medium);
}

.accent-solid-strong ::-moz-selection {
  background-color: var(--accent-background-weak);
  color: var(--accent-on-background-medium);
}
...
.info-background-weak ::-moz-selection {
  background-color: var(--info-on-background-weak);
  color: var(--info-background-weak);
}

.info-background-medium ::-moz-selection {
  background-color: var(--info-on-background-weak);
  color: var(--info-background-weak);
}

.info-background-strong ::-moz-selection {
  background-color: var(--info-on-background-weak);
  color: var(--info-background-weak);
}

.info-background-alpha-weak ::-moz-selection {
  background-color: var(--info-on-background-weak);
  color: var(--info-background-weak);
}

.info-background-alpha-medium ::-moz-selection {
  background-color: var(--info-on-background-weak);
  color: var(--info-background-weak);
}

.info-background-alpha-strong ::-moz-selection {
  background-color: var(--info-on-background-weak);
  color: var(--info-background-weak);
}
...
.info-solid-weak ::-moz-selection {
  background-color: var(--info-background-weak);
  color: var(--info-on-background-medium);
}

.info-solid-medium ::-moz-selection {
  background-color: var(--info-background-weak);
  color: var(--info-on-background-medium);
}

.info-solid-strong ::-moz-selection {
  background-color: var(--info-background-weak);
  color: var(--info-on-background-medium);
}
...
.danger-background-weak ::-moz-selection {
  background-color: var(--danger-on-background-weak);
  color: var(--danger-background-weak);
}

.danger-background-medium ::-moz-selection {
  background-color: var(--danger-on-background-weak);
  color: var(--danger-background-weak);
}

.danger-background-strong ::-moz-selection {
  background-color: var(--danger-on-background-weak);
  color: var(--danger-background-weak);
}

.danger-background-alpha-weak ::-moz-selection {
  background-color: var(--danger-on-background-weak);
  color: var(--danger-background-weak);
}

.danger-background-alpha-medium ::-moz-selection {
  background-color: var(--danger-on-background-weak);
  color: var(--danger-background-weak);
}

.danger-background-alpha-strong ::-moz-selection {
  background-color: var(--danger-on-background-weak);
  color: var(--danger-background-weak);
}
...
.danger-solid-weak ::-moz-selection {
  background-color: var(--danger-background-weak);
  color: var(--danger-on-background-medium);
}

.danger-solid-medium ::-moz-selection {
  background-color: var(--danger-background-weak);
  color: var(--danger-on-background-medium);
}

.danger-solid-strong ::-moz-selection {
  background-color: var(--danger-background-weak);
  color: var(--danger-on-background-medium);
}
...
.warning-background-weak ::-moz-selection {
  background-color: var(--warning-on-background-weak);
  color: var(--warning-background-weak);
}

.warning-background-medium ::-moz-selection {
  background-color: var(--warning-on-background-weak);
  color: var(--warning-background-weak);
}

.warning-background-strong ::-moz-selection {
  background-color: var(--warning-on-background-weak);
  color: var(--warning-background-weak);
}

.warning-background-alpha-weak ::-moz-selection {
  background-color: var(--warning-on-background-weak);
  color: var(--warning-background-weak);
}

.warning-background-alpha-medium ::-moz-selection {
  background-color: var(--warning-on-background-weak);
  color: var(--warning-background-weak);
}

.warning-background-alpha-strong ::-moz-selection {
  background-color: var(--warning-on-background-weak);
  color: var(--warning-background-weak);
}
...
.warning-solid-weak ::-moz-selection {
  background-color: var(--warning-background-weak);
  color: var(--warning-on-background-medium);
}

.warning-solid-medium ::-moz-selection {
  background-color: var(--warning-background-weak);
  color: var(--warning-on-background-medium);
}

.warning-solid-strong ::-moz-selection {
  background-color: var(--warning-background-weak);
  color: var(--warning-on-background-medium);
}
...
.success-background-weak ::-moz-selection {
  background-color: var(--success-on-background-weak);
  color: var(--success-background-weak);
}

.success-background-medium ::-moz-selection {
  background-color: var(--success-on-background-weak);
  color: var(--success-background-weak);
}

.success-background-strong ::-moz-selection {
  background-color: var(--success-on-background-weak);
  color: var(--success-background-weak);
}

.success-background-alpha-weak ::-moz-selection {
  background-color: var(--success-on-background-weak);
  color: var(--success-background-weak);
}

.success-background-alpha-medium ::-moz-selection {
  background-color: var(--success-on-background-weak);
  color: var(--success-background-weak);
}

.success-background-alpha-strong ::-moz-selection {
  background-color: var(--success-on-background-weak);
  color: var(--success-background-weak);
}
...
.success-solid-weak ::-moz-selection {
  background-color: var(--success-background-weak);
  color: var(--success-on-background-medium);
}

.success-solid-medium ::-moz-selection {
  background-color: var(--success-background-weak);
  color: var(--success-on-background-medium);
}

.success-solid-strong ::-moz-selection {
  background-color: var(--success-background-weak);
  color: var(--success-on-background-medium);
}
